...
<head>
  ...
  <style>
    ...
    .badge-role{border-radius:20px;padding:6px 12px;font-weight:600}
  </style>
</head>
<body>
    ...
    <div class="container">
      <div class="main-content">
        <div class="d-flex justify-content-between align-items-center mb-4">
          <h3 class="mb-0"><i class="fas fa-users me-2"></i>Utilisateurs</h3>
          ...
          <table class="table table-hover align-middle">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $user->email }}</td>
                <td>
                  <span class="badge bg-{{ $user->role === 'ADMIN' ? 'danger' : ($user->role === 'AGENCE' ? 'info' : 'secondary') }} badge-role">
                    {{ $user->role }}
                  </span>
                </td>
                        ...
                        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
                          ...
                          <div class="modal-body">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" name="contactdetails" class="form-control" value="{{ $user->contactdetails }}">
                            </div>
                            <div class="mb-3">
